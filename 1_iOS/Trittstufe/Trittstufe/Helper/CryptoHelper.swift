...
/// Crypto Helper to encrypt the JSON to the Car. It takes a string as payload and the public key of the reciever. In the method the encrypted string is generated by usign the Curve 25519 algortihm and Cha Cha Poly seal box.
struct CryptoHelper {
