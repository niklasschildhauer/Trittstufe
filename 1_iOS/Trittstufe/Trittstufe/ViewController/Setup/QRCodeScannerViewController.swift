...
class QRCodeScannerViewController: UIViewController {
    ...
    func failed() {
        let ac = UIAlertController(title: NSLocalizedString("QRCodeScannerViewController_Error_Title", comment: ""), message: NSLocalizedString("QRCodeScannerViewController_Error_Message", comment: ""), preferredStyle: .alert)
